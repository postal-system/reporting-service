...
import io.codero.reportingservice.service.facade.PostOfficeReportFacade
...
@RestController
@RequestMapping("/api/reports/post-office")
class PostOfficeReportController(
    ...
    fun getReportByWeek(
        ...
        return ResponseEntity.ok()
            .headers(headers)
            .body(InputStreamResource(facade.getReportByWeekFile(date, type)))
    }
}